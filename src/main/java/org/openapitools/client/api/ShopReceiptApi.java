...
public class ShopReceiptApi {
    ...
    private okhttp3.Call createReceiptShipmentValidateBeforeCall(Long shopId, Long receiptId, String trackingCode, String carrierName, Boolean sendBcc, String noteToBuyer, final ApiCallback _callback) throws ApiException {
        ...
        return createReceiptShipmentCall(shopId, receiptId, trackingCode, carrierName, sendBcc, noteToBuyer, _callback);
    ...
    private okhttp3.Call getShopReceiptValidateBeforeCall(Long shopId, Long receiptId, final ApiCallback _callback) throws ApiException {
        ...
        return getShopReceiptCall(shopId, receiptId, _callback);
     ...
     */
    public okhttp3.Call getShopReceiptsCall(Long shopId, Long minCreated, Long maxCreated, Long minLastModified, Long maxLastModified, Long limit, Long offset, String sortOn, String sortOrder, Boolean wasPaid, Boolean wasShipped, Boolean wasDelivered, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getShopReceiptsValidateBeforeCall(Long shopId, Long minCreated, Long maxCreated, Long minLastModified, Long maxLastModified, Long limit, Long offset, String sortOn, String sortOrder, Boolean wasPaid, Boolean wasShipped, Boolean wasDelivered, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shopId' is set
        if (shopId == null) {
            throw new ApiException("Missing the required parameter 'shopId' when calling getShopReceipts(Async)");
        }

        return getShopReceiptsCall(shopId, minCreated, maxCreated, minLastModified, maxLastModified, limit, offset, sortOn, sortOrder, wasPaid, wasShipped, wasDelivered, _callback);
     ...
     */
    public ShopReceipts getShopReceipts(Long shopId, Long minCreated, Long maxCreated, Long minLastModified, Long maxLastModified, Long limit, Long offset, String sortOn, String sortOrder, Boolean wasPaid, Boolean wasShipped, Boolean wasDelivered) throws ApiException {
        ApiResponse<ShopReceipts> localVarResp = getShopReceiptsWithHttpInfo(shopId, minCreated, maxCreated, minLastModified, maxLastModified, limit, offset, sortOn, sortOrder, wasPaid, wasShipped, wasDelivered);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ShopReceipts> getShopReceiptsWithHttpInfo(Long shopId, Long minCreated, Long maxCreated, Long minLastModified, Long maxLastModified, Long limit, Long offset, String sortOn, String sortOrder, Boolean wasPaid, Boolean wasShipped, Boolean wasDelivered) throws ApiException {
        okhttp3.Call localVarCall = getShopReceiptsValidateBeforeCall(shopId, minCreated, maxCreated, minLastModified, maxLastModified, limit, offset, sortOn, sortOrder, wasPaid, wasShipped, wasDelivered, null);
     ...
     */
    public okhttp3.Call getShopReceiptsAsync(Long shopId, Long minCreated, Long maxCreated, Long minLastModified, Long maxLastModified, Long limit, Long offset, String sortOn, String sortOrder, Boolean wasPaid, Boolean wasShipped, Boolean wasDelivered, final ApiCallback<ShopReceipts> _callback) throws ApiException {

        okhttp3.Call localVarCall = getShopReceiptsValidateBeforeCall(shopId, minCreated, maxCreated, minLastModified, maxLastModified, limit, offset, sortOn, sortOrder, wasPaid, wasShipped, wasDelivered, _callback);
        Type localVarReturnType = new TypeToken<ShopReceipts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call updateShopReceiptValidateBeforeCall(Long shopId, Long receiptId, Boolean wasShipped, Boolean wasPaid, final ApiCallback _callback) throws ApiException {
        ...
        return updateShopReceiptCall(shopId, receiptId, wasShipped, wasPaid, _callback);
