...
public class ShopShippingProfileApi {
    ...
    private okhttp3.Call createShopShippingProfileValidateBeforeCall(Long shopId, String title, String originCountryIso, Float primaryCost, Float secondaryCost, Long minProcessingTime, Long maxProcessingTime, String processingTimeUnit, String destinationCountryIso, String destinationRegion, String originPostalCode, Long shippingCarrierId, String mailClass, Long minDeliveryDays, Long maxDeliveryDays, final ApiCallback _callback) throws ApiException {
        ...
        return createShopShippingProfileCall(shopId, title, originCountryIso, primaryCost, secondaryCost, minProcessingTime, maxProcessingTime, processingTimeUnit, destinationCountryIso, destinationRegion, originPostalCode, shippingCarrierId, mailClass, minDeliveryDays, maxDeliveryDays, _callback);
     ...
     * @param shopId The unique positive non-zero numeric ID for an Etsy Shop. (required)
     * @param shippingProfileId The numeric ID of the [shipping profile](/documentation/reference#operation/getShopShippingProfile) associated with the listing. Required when listing type is &#x60;physical&#x60;. (required)
     * @param primaryCost The cost of shipping to this country/region alone, measured in the store&#39;s default currency. (required)
     * @param secondaryCost The cost of shipping to this country/region with another item, measured in the store&#39;s default currency. (required)
     * @param destinationCountryIso The ISO code of the country to which the listing ships. If null, request sets destination to destination_region. Required if destination_region is null or not provided. (optional)
     * @param destinationRegion The code of the region to which the listing ships. A region represents a set of countries. Supported regions are Europe Union and Non-Europe Union (countries in Europe not in EU). If &#x60;none&#x60;, request sets destination to destination_country_iso. Required if destination_country_iso is null or not provided. (optional, default to none)
    ...
    public okhttp3.Call createShopShippingProfileDestinationCall(Long shopId, Long shippingProfileId, Float primaryCost, Float secondaryCost, String destinationCountryIso, String destinationRegion, Long shippingCarrierId, String mailClass, Long minDeliveryDays, Long maxDeliveryDays, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v3/application/shops/{shop_id}/shipping-profiles/{shipping_profile_id}/destinations"
            .replace("{" + "shop_id" + "}", localVarApiClient.escapeString(shopId.toString()))
            .replace("{" + "shipping_profile_id" + "}", localVarApiClient.escapeString(shippingProfileId.toString()));
    ...
    private okhttp3.Call createShopShippingProfileDestinationValidateBeforeCall(Long shopId, Long shippingProfileId, Float primaryCost, Float secondaryCost, String destinationCountryIso, String destinationRegion, Long shippingCarrierId, String mailClass, Long minDeliveryDays, Long maxDeliveryDays, final ApiCallback _callback) throws ApiException {
        ...
        return createShopShippingProfileDestinationCall(shopId, shippingProfileId, primaryCost, secondaryCost, destinationCountryIso, destinationRegion, shippingCarrierId, mailClass, minDeliveryDays, maxDeliveryDays, _callback);
    ...
    private okhttp3.Call createShopShippingProfileUpgradeValidateBeforeCall(Long shopId, Long shippingProfileId, String type, String upgradeName, Float price, Float secondaryPrice, Long shippingCarrierId, String mailClass, Long minDeliveryDays, Long maxDeliveryDays, final ApiCallback _callback) throws ApiException {
        ...
        return createShopShippingProfileUpgradeCall(shopId, shippingProfileId, type, upgradeName, price, secondaryPrice, shippingCarrierId, mailClass, minDeliveryDays, maxDeliveryDays, _callback);
    ...
    private okhttp3.Call deleteShopShippingProfileValidateBeforeCall(Long shopId, Long shippingProfileId, final ApiCallback _callback) throws ApiException {
        ...
        return deleteShopShippingProfileCall(shopId, shippingProfileId, _callback);
     ...
     * @param shopId The unique positive non-zero numeric ID for an Etsy Shop. (required)
     * @param shippingProfileId The numeric ID of the [shipping profile](/documentation/reference#operation/getShopShippingProfile) associated with the listing. Required when listing type is &#x60;physical&#x60;. (required)
     * @param shippingProfileDestinationId The numeric ID of the shipping profile destination in the [shipping profile](/documentation/reference#tag/Shop-ShippingProfile) associated with the listing. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call deleteShopShippingProfileDestinationCall(Long shopId, Long shippingProfileId, Long shippingProfileDestinationId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v3/application/shops/{shop_id}/shipping-profiles/{shipping_profile_id}/destinations/{shipping_profile_destination_id}"
            .replace("{" + "shop_id" + "}", localVarApiClient.escapeString(shopId.toString()))
            .replace("{" + "shipping_profile_id" + "}", localVarApiClient.escapeString(shippingProfileId.toString()))
            .replace("{" + "shipping_profile_destination_id" + "}", localVarApiClient.escapeString(shippingProfileDestinationId.toString()));
    ...
    private okhttp3.Call deleteShopShippingProfileDestinationValidateBeforeCall(Long shopId, Long shippingProfileId, Long shippingProfileDestinationId, final ApiCallback _callback) throws ApiException {
        ...
        return deleteShopShippingProfileDestinationCall(shopId, shippingProfileId, shippingProfileDestinationId, _callback);
    ...
    public okhttp3.Call deleteShopShippingProfileUpgradeCall(Long shopId, Long shippingProfileId, Long upgradeId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v3/application/shops/{shop_id}/shipping-profiles/{shipping_profile_id}/upgrades/{upgrade_id}"
            .replace("{" + "shop_id" + "}", localVarApiClient.escapeString(shopId.toString()))
            .replace("{" + "shipping_profile_id" + "}", localVarApiClient.escapeString(shippingProfileId.toString()))
            .replace("{" + "upgrade_id" + "}", localVarApiClient.escapeString(upgradeId.toString()));
    ...
    private okhttp3.Call deleteShopShippingProfileUpgradeValidateBeforeCall(Long shopId, Long shippingProfileId, Long upgradeId, final ApiCallback _callback) throws ApiException {
        ...
        return deleteShopShippingProfileUpgradeCall(shopId, shippingProfileId, upgradeId, _callback);
    ...
    private okhttp3.Call getShippingCarriersValidateBeforeCall(String originCountryIso, final ApiCallback _callback) throws ApiException {
        ...
        return getShippingCarriersCall(originCountryIso, _callback);
    ...
    private okhttp3.Call getShopShippingProfileValidateBeforeCall(Long shopId, Long shippingProfileId, final ApiCallback _callback) throws ApiException {
        ...
        return getShopShippingProfileCall(shopId, shippingProfileId, _callback);
    ...
    private okhttp3.Call getShopShippingProfileDestinationsByShippingProfileValidateBeforeCall(Long shopId, Long shippingProfileId, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        ...
        return getShopShippingProfileDestinationsByShippingProfileCall(shopId, shippingProfileId, limit, offset, _callback);
    ...
    private okhttp3.Call getShopShippingProfileUpgradesValidateBeforeCall(Long shopId, Long shippingProfileId, final ApiCallback _callback) throws ApiException {
        ...
        return getShopShippingProfileUpgradesCall(shopId, shippingProfileId, _callback);
    ...
    private okhttp3.Call getShopShippingProfilesValidateBeforeCall(Long shopId, final ApiCallback _callback) throws ApiException {
        ...
        return getShopShippingProfilesCall(shopId, _callback);
     ...
     * @param processingTimeUnit The unit used to represent how long a processing time is. A week is equivalent to 5 business days. If none is provided, the unit is set to \\\&quot;business_days\\\&quot;. (optional, default to business_days)
     * @param originPostalCode The postal code string (not necessarily a number) for the location from which the listing ships. Required if the &#x60;origin_country_iso&#x60; is &#x60;US&#x60; or &#x60;CA&#x60;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call updateShopShippingProfileValidateBeforeCall(Long shopId, Long shippingProfileId, String title, String originCountryIso, Long minProcessingTime, Long maxProcessingTime, String processingTimeUnit, String originPostalCode, final ApiCallback _callback) throws ApiException {
        ...
        return updateShopShippingProfileCall(shopId, shippingProfileId, title, originCountryIso, minProcessingTime, maxProcessingTime, processingTimeUnit, originPostalCode, _callback);
    ...
    private okhttp3.Call updateShopShippingProfileDestinationValidateBeforeCall(Long shopId, Long shippingProfileId, Long shippingProfileDestinationId, Float primaryCost, Float secondaryCost, String destinationCountryIso, String destinationRegion, Long shippingCarrierId, String mailClass, Long minDeliveryDays, Long maxDeliveryDays, final ApiCallback _callback) throws ApiException {
        ...
        return updateShopShippingProfileDestinationCall(shopId, shippingProfileId, shippingProfileDestinationId, primaryCost, secondaryCost, destinationCountryIso, destinationRegion, shippingCarrierId, mailClass, minDeliveryDays, maxDeliveryDays, _callback);
    ...
    private okhttp3.Call updateShopShippingProfileUpgradeValidateBeforeCall(Long shopId, Long shippingProfileId, Long upgradeId, String upgradeName, String type, Float price, Float secondaryPrice, Long shippingCarrierId, String mailClass, Long minDeliveryDays, Long maxDeliveryDays, final ApiCallback _callback) throws ApiException {
        ...
        return updateShopShippingProfileUpgradeCall(shopId, shippingProfileId, upgradeId, upgradeName, type, price, secondaryPrice, shippingCarrierId, mailClass, minDeliveryDays, maxDeliveryDays, _callback);
