...
public class UserApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Fetches basic info about the requesting user </td><td>  -  </td></tr>
    ...
    public okhttp3.Call getMeCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v3/application/users/me";
     ...
     */
    public Self getMe() throws ApiException {
        ApiResponse<Self> localVarResp = getMeWithHttpInfo();
     ...
     */
    public ApiResponse<Self> getMeWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getMeValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Self>(){}.getType();
     ...
     */
    public okhttp3.Call getMeAsync(final ApiCallback<Self> _callback) throws ApiException {
    ...
    public okhttp3.Call getUserCall(Long userId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v3/application/users/{user_id}"
