...
public class BuyerTaxonomyNodeProperty {
  ...
  **/
  ...
  public BuyerTaxonomyNodeProperty scales(List<BuyerTaxonomyNodePropertyScalesInner> scales) {
    
    this.scales = scales;
    return this;
  }

  public BuyerTaxonomyNodeProperty addScalesItem(BuyerTaxonomyNodePropertyScalesInner scalesItem) {
    if (this.scales == null) {
  ...
  **/
  ...
  public BuyerTaxonomyNodeProperty possibleValues(List<BuyerTaxonomyNodePropertyPossibleValuesInner> possibleValues) {
    
    this.possibleValues = possibleValues;
    return this;
  }

  public BuyerTaxonomyNodeProperty addPossibleValuesItem(BuyerTaxonomyNodePropertyPossibleValuesInner possibleValuesItem) {
  ...
  **/
  ...
  public BuyerTaxonomyNodeProperty selectedValues(List<BuyerTaxonomyNodePropertySelectedValuesInner> selectedValues) {
    
    this.selectedValues = selectedValues;
    return this;
  }

  public BuyerTaxonomyNodeProperty addSelectedValuesItem(BuyerTaxonomyNodePropertySelectedValuesInner selectedValuesItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BuyerTaxonomyNodeProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BuyerTaxonomyNodeProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuyerTaxonomyNodeProperty is not found in the empty JSON string", BuyerTaxonomyNodeProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BuyerTaxonomyNodeProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuyerTaxonomyNodeProperty` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuyerTaxonomyNodeProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuyerTaxonomyNodeProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuyerTaxonomyNodeProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuyerTaxonomyNodeProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<BuyerTaxonomyNodeProperty>() {
           @Override
           public void write(JsonWriter out, BuyerTaxonomyNodeProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuyerTaxonomyNodeProperty read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BuyerTaxonomyNodeProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BuyerTaxonomyNodeProperty
  * @throws IOException if the JSON string is invalid with respect to BuyerTaxonomyNodeProperty
  */
  public static BuyerTaxonomyNodeProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuyerTaxonomyNodeProperty.class);
  }

 /**
  * Convert an instance of BuyerTaxonomyNodeProperty to an JSON string
  *
  * @return JSON string
  */
