...
public class ShopReceipt {
  ...
  **/
  ...
  public ShopReceipt giftSender(String giftSender) {
  ...
  **/
  ...
  public ShopReceipt grandtotal(ShopReceiptGrandtotal grandtotal) {
  ...
  **/
  ...
  public ShopReceipt subtotal(ShopReceiptSubtotal subtotal) {
  ...
  **/
  ...
  public ShopReceipt totalPrice(ShopReceiptTotalPrice totalPrice) {
  ...
  **/
  ...
  public ShopReceipt totalShippingCost(ShopReceiptTotalShippingCost totalShippingCost) {
  ...
  **/
  ...
  public ShopReceipt totalTaxCost(ShopReceiptTotalTaxCost totalTaxCost) {
  ...
  **/
  ...
  public ShopReceipt totalVatCost(ShopReceiptTotalVatCost totalVatCost) {
  ...
  **/
  ...
  public ShopReceipt discountAmt(ShopReceiptDiscountAmt discountAmt) {
  ...
  **/
  ...
  public ShopReceipt giftWrapPrice(ShopReceiptGiftWrapPrice giftWrapPrice) {
  ...
  **/
  ...
  public ShopReceipt shipments(List<ShopReceiptShipmentsInner> shipments) {
    
    this.shipments = shipments;
    return this;
  }

  public ShopReceipt addShipmentsItem(ShopReceiptShipmentsInner shipmentsItem) {
  ...
  **/
  ...
  public ShopReceipt transactions(List<ShopReceiptTransactionsInner> transactions) {
    
    this.transactions = transactions;
    return this;
  }

  public ShopReceipt addTransactionsItem(ShopReceiptTransactionsInner transactionsItem) {
  ...
  **/
  ...
  public ShopReceipt refunds(List<ShopReceiptRefundsInner> refunds) {
    
    this.refunds = refunds;
    return this;
  }

  public ShopReceipt addRefundsItem(ShopReceiptRefundsInner refundsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.receiptId, shopReceipt.receiptId) &&
        ...
        Objects.equals(this.giftSender, shopReceipt.giftSender) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopReceipt
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopReceipt.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopReceipt is not found in the empty JSON string", ShopReceipt.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopReceipt.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopReceipt` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopReceipt.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopReceipt' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopReceipt> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopReceipt.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopReceipt>() {
           @Override
           public void write(JsonWriter out, ShopReceipt value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopReceipt read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopReceipt given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopReceipt
  * @throws IOException if the JSON string is invalid with respect to ShopReceipt
  */
  public static ShopReceipt fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopReceipt.class);
  }

 /**
  * Convert an instance of ShopReceipt to an JSON string
  *
  * @return JSON string
  */
