...
public class ListingInventoryProduct {
  ...
  **/
  ...
  public ListingInventoryProduct offerings(List<ListingInventoryProductOfferingsInner> offerings) {
    
    this.offerings = offerings;
    return this;
  }

  public ListingInventoryProduct addOfferingsItem(ListingInventoryProductOfferingsInner offeringsItem) {
  ...
  **/
  ...
  public ListingInventoryProduct propertyValues(List<ListingInventoryProductPropertyValuesInner> propertyValues) {
    
    this.propertyValues = propertyValues;
    return this;
  }

  public ListingInventoryProduct addPropertyValuesItem(ListingInventoryProductPropertyValuesInner propertyValuesItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListingInventoryProduct
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListingInventoryProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListingInventoryProduct is not found in the empty JSON string", ListingInventoryProduct.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListingInventoryProduct.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListingInventoryProduct` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListingInventoryProduct.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListingInventoryProduct' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListingInventoryProduct> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListingInventoryProduct.class));

       return (TypeAdapter<T>) new TypeAdapter<ListingInventoryProduct>() {
           @Override
           public void write(JsonWriter out, ListingInventoryProduct value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListingInventoryProduct read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListingInventoryProduct given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListingInventoryProduct
  * @throws IOException if the JSON string is invalid with respect to ListingInventoryProduct
  */
  public static ListingInventoryProduct fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListingInventoryProduct.class);
  }

 /**
  * Convert an instance of ListingInventoryProduct to an JSON string
  *
  * @return JSON string
  */
