...
public class ListingImage {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListingImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListingImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListingImage is not found in the empty JSON string", ListingImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListingImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListingImage` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListingImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListingImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListingImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListingImage.class));

       return (TypeAdapter<T>) new TypeAdapter<ListingImage>() {
           @Override
           public void write(JsonWriter out, ListingImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListingImage read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListingImage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListingImage
  * @throws IOException if the JSON string is invalid with respect to ListingImage
  */
  public static ListingImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListingImage.class);
  }

 /**
  * Convert an instance of ListingImage to an JSON string
  *
  * @return JSON string
  */
