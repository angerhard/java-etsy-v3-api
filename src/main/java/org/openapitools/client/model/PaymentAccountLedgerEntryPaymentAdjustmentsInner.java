...
public class PaymentAccountLedgerEntryPaymentAdjustmentsInner {
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner() {
  }

  public PaymentAccountLedgerEntryPaymentAdjustmentsInner paymentAdjustmentId(Long paymentAdjustmentId) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner paymentId(Long paymentId) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner status(String status) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner isSuccess(Boolean isSuccess) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner userId(Long userId) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner reasonCode(String reasonCode) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner totalAdjustmentAmount(Long totalAdjustmentAmount) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner shopTotalAdjustmentAmount(Long shopTotalAdjustmentAmount) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner buyerTotalAdjustmentAmount(Long buyerTotalAdjustmentAmount) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner totalFeeAdjustmentAmount(Long totalFeeAdjustmentAmount) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner createTimestamp(Long createTimestamp) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner createdTimestamp(Long createdTimestamp) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner updateTimestamp(Long updateTimestamp) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner updatedTimestamp(Long updatedTimestamp) {
  ...
  **/
  ...
  public PaymentAccountLedgerEntryPaymentAdjustmentsInner paymentAdjustmentItems(List<PaymentAdjustmentPaymentAdjustmentItemsInner> paymentAdjustmentItems) {
    
    this.paymentAdjustmentItems = paymentAdjustmentItems;
    return this;
  }

  public PaymentAccountLedgerEntryPaymentAdjustmentsInner addPaymentAdjustmentItemsItem(PaymentAdjustmentPaymentAdjustmentItemsInner paymentAdjustmentItemsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaymentAccountLedgerEntryPaymentAdjustmentsInner paymentAccountLedgerEntryPaymentAdjustmentsInner = (PaymentAccountLedgerEntryPaymentAdjustmentsInner) o;
    return Objects.equals(this.paymentAdjustmentId, paymentAccountLedgerEntryPaymentAdjustmentsInner.paymentAdjustmentId) &&
        Objects.equals(this.paymentId, paymentAccountLedgerEntryPaymentAdjustmentsInner.paymentId) &&
        Objects.equals(this.status, paymentAccountLedgerEntryPaymentAdjustmentsInner.status) &&
        Objects.equals(this.isSuccess, paymentAccountLedgerEntryPaymentAdjustmentsInner.isSuccess) &&
        Objects.equals(this.userId, paymentAccountLedgerEntryPaymentAdjustmentsInner.userId) &&
        Objects.equals(this.reasonCode, paymentAccountLedgerEntryPaymentAdjustmentsInner.reasonCode) &&
        Objects.equals(this.totalAdjustmentAmount, paymentAccountLedgerEntryPaymentAdjustmentsInner.totalAdjustmentAmount) &&
        Objects.equals(this.shopTotalAdjustmentAmount, paymentAccountLedgerEntryPaymentAdjustmentsInner.shopTotalAdjustmentAmount) &&
        Objects.equals(this.buyerTotalAdjustmentAmount, paymentAccountLedgerEntryPaymentAdjustmentsInner.buyerTotalAdjustmentAmount) &&
        Objects.equals(this.totalFeeAdjustmentAmount, paymentAccountLedgerEntryPaymentAdjustmentsInner.totalFeeAdjustmentAmount) &&
        Objects.equals(this.createTimestamp, paymentAccountLedgerEntryPaymentAdjustmentsInner.createTimestamp) &&
        Objects.equals(this.createdTimestamp, paymentAccountLedgerEntryPaymentAdjustmentsInner.createdTimestamp) &&
        Objects.equals(this.updateTimestamp, paymentAccountLedgerEntryPaymentAdjustmentsInner.updateTimestamp) &&
        Objects.equals(this.updatedTimestamp, paymentAccountLedgerEntryPaymentAdjustmentsInner.updatedTimestamp) &&
        Objects.equals(this.paymentAdjustmentItems, paymentAccountLedgerEntryPaymentAdjustmentsInner.paymentAdjustmentItems);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentAccountLedgerEntryPaymentAdjustmentsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentAccountLedgerEntryPaymentAdjustmentsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentAccountLedgerEntryPaymentAdjustmentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAccountLedgerEntryPaymentAdjustmentsInner is not found in the empty JSON string", PaymentAccountLedgerEntryPaymentAdjustmentsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentAccountLedgerEntryPaymentAdjustmentsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentAccountLedgerEntryPaymentAdjustmentsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAccountLedgerEntryPaymentAdjustmentsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAccountLedgerEntryPaymentAdjustmentsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAccountLedgerEntryPaymentAdjustmentsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAccountLedgerEntryPaymentAdjustmentsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAccountLedgerEntryPaymentAdjustmentsInner>() {
           @Override
           public void write(JsonWriter out, PaymentAccountLedgerEntryPaymentAdjustmentsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentAccountLedgerEntryPaymentAdjustmentsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaymentAccountLedgerEntryPaymentAdjustmentsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentAccountLedgerEntryPaymentAdjustmentsInner
  * @throws IOException if the JSON string is invalid with respect to PaymentAccountLedgerEntryPaymentAdjustmentsInner
  */
  public static PaymentAccountLedgerEntryPaymentAdjustmentsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAccountLedgerEntryPaymentAdjustmentsInner.class);
  }

 /**
  * Convert an instance of PaymentAccountLedgerEntryPaymentAdjustmentsInner to an JSON string
  *
  * @return JSON string
  */
