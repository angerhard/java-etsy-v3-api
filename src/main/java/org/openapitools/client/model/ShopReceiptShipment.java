...
public class ShopReceiptShipment {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopReceiptShipment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopReceiptShipment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopReceiptShipment is not found in the empty JSON string", ShopReceiptShipment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopReceiptShipment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopReceiptShipment` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopReceiptShipment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopReceiptShipment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopReceiptShipment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopReceiptShipment.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopReceiptShipment>() {
           @Override
           public void write(JsonWriter out, ShopReceiptShipment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopReceiptShipment read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopReceiptShipment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopReceiptShipment
  * @throws IOException if the JSON string is invalid with respect to ShopReceiptShipment
  */
  public static ShopReceiptShipment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopReceiptShipment.class);
  }

 /**
  * Convert an instance of ShopReceiptShipment to an JSON string
  *
  * @return JSON string
  */
