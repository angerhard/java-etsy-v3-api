...
public class Shop {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Shop
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Shop.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Shop is not found in the empty JSON string", Shop.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Shop.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Shop` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Shop.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Shop' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Shop> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Shop.class));

       return (TypeAdapter<T>) new TypeAdapter<Shop>() {
           @Override
           public void write(JsonWriter out, Shop value) throws IOException {
 ...
 /**
  * Create an instance of Shop given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Shop
  * @throws IOException if the JSON string is invalid with respect to Shop
  */
  public static Shop fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Shop.class);
  }

 /**
  * Convert an instance of Shop to an JSON string
  *
  * @return JSON string
  */
