...
public class PaymentsResultsInner {
  ...
  public PaymentsResultsInner() {
  }

  public PaymentsResultsInner paymentId(Long paymentId) {
  ...
  **/
  ...
  public PaymentsResultsInner buyerUserId(Long buyerUserId) {
  ...
  **/
  ...
  public PaymentsResultsInner shopId(Long shopId) {
  ...
  **/
  ...
  public PaymentsResultsInner receiptId(Long receiptId) {
  ...
  **/
  ...
  public PaymentsResultsInner amountGross(PaymentAmountGross amountGross) {
  ...
  **/
  ...
  public PaymentsResultsInner amountFees(PaymentAmountFees amountFees) {
  ...
  **/
  ...
  public PaymentsResultsInner amountNet(PaymentAmountNet amountNet) {
  ...
  **/
  ...
  public PaymentsResultsInner postedGross(PaymentPostedGross postedGross) {
  ...
  **/
  ...
  public PaymentsResultsInner postedFees(PaymentPostedFees postedFees) {
  ...
  **/
  ...
  public PaymentsResultsInner postedNet(PaymentPostedNet postedNet) {
  ...
  **/
  ...
  public PaymentsResultsInner adjustedGross(PaymentAdjustedGross adjustedGross) {
  ...
  **/
  ...
  public PaymentsResultsInner adjustedFees(PaymentAdjustedFees adjustedFees) {
  ...
  **/
  ...
  public PaymentsResultsInner adjustedNet(PaymentAdjustedNet adjustedNet) {
  ...
  **/
  ...
  public PaymentsResultsInner currency(String currency) {
  ...
  **/
  ...
  public PaymentsResultsInner shopCurrency(String shopCurrency) {
  ...
  **/
  ...
  public PaymentsResultsInner buyerCurrency(String buyerCurrency) {
  ...
  **/
  ...
  public PaymentsResultsInner shippingUserId(Long shippingUserId) {
  ...
  **/
  ...
  public PaymentsResultsInner shippingAddressId(Long shippingAddressId) {
  ...
  **/
  ...
  public PaymentsResultsInner billingAddressId(Long billingAddressId) {
  ...
  **/
  ...
  public PaymentsResultsInner status(String status) {
  ...
  **/
  ...
  public PaymentsResultsInner shippedTimestamp(Long shippedTimestamp) {
  ...
  **/
  ...
  public PaymentsResultsInner createTimestamp(Long createTimestamp) {
  ...
  **/
  ...
  public PaymentsResultsInner createdTimestamp(Long createdTimestamp) {
  ...
  **/
  ...
  public PaymentsResultsInner updateTimestamp(Long updateTimestamp) {
  ...
  **/
  ...
  public PaymentsResultsInner updatedTimestamp(Long updatedTimestamp) {
  ...
  **/
  ...
  public PaymentsResultsInner paymentAdjustments(List<PaymentAccountLedgerEntryPaymentAdjustmentsInner> paymentAdjustments) {
    
    this.paymentAdjustments = paymentAdjustments;
    return this;
  }

  public PaymentsResultsInner addPaymentAdjustmentsItem(PaymentAccountLedgerEntryPaymentAdjustmentsInner paymentAdjustmentsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaymentsResultsInner paymentsResultsInner = (PaymentsResultsInner) o;
    return Objects.equals(this.paymentId, paymentsResultsInner.paymentId) &&
        Objects.equals(this.buyerUserId, paymentsResultsInner.buyerUserId) &&
        Objects.equals(this.shopId, paymentsResultsInner.shopId) &&
        Objects.equals(this.receiptId, paymentsResultsInner.receiptId) &&
        Objects.equals(this.amountGross, paymentsResultsInner.amountGross) &&
        Objects.equals(this.amountFees, paymentsResultsInner.amountFees) &&
        Objects.equals(this.amountNet, paymentsResultsInner.amountNet) &&
        Objects.equals(this.postedGross, paymentsResultsInner.postedGross) &&
        Objects.equals(this.postedFees, paymentsResultsInner.postedFees) &&
        Objects.equals(this.postedNet, paymentsResultsInner.postedNet) &&
        Objects.equals(this.adjustedGross, paymentsResultsInner.adjustedGross) &&
        Objects.equals(this.adjustedFees, paymentsResultsInner.adjustedFees) &&
        Objects.equals(this.adjustedNet, paymentsResultsInner.adjustedNet) &&
        Objects.equals(this.currency, paymentsResultsInner.currency) &&
        Objects.equals(this.shopCurrency, paymentsResultsInner.shopCurrency) &&
        Objects.equals(this.buyerCurrency, paymentsResultsInner.buyerCurrency) &&
        Objects.equals(this.shippingUserId, paymentsResultsInner.shippingUserId) &&
        Objects.equals(this.shippingAddressId, paymentsResultsInner.shippingAddressId) &&
        Objects.equals(this.billingAddressId, paymentsResultsInner.billingAddressId) &&
        Objects.equals(this.status, paymentsResultsInner.status) &&
        Objects.equals(this.shippedTimestamp, paymentsResultsInner.shippedTimestamp) &&
        Objects.equals(this.createTimestamp, paymentsResultsInner.createTimestamp) &&
        Objects.equals(this.createdTimestamp, paymentsResultsInner.createdTimestamp) &&
        Objects.equals(this.updateTimestamp, paymentsResultsInner.updateTimestamp) &&
        Objects.equals(this.updatedTimestamp, paymentsResultsInner.updatedTimestamp) &&
        Objects.equals(this.paymentAdjustments, paymentsResultsInner.paymentAdjustments);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentsResultsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentsResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentsResultsInner is not found in the empty JSON string", PaymentsResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentsResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentsResultsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentsResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentsResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentsResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentsResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentsResultsInner>() {
           @Override
           public void write(JsonWriter out, PaymentsResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentsResultsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaymentsResultsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentsResultsInner
  * @throws IOException if the JSON string is invalid with respect to PaymentsResultsInner
  */
  public static PaymentsResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentsResultsInner.class);
  }

 /**
  * Convert an instance of PaymentsResultsInner to an JSON string
  *
  * @return JSON string
  */
