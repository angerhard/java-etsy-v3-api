...
public class BuyerTaxonomyPropertyValue {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BuyerTaxonomyPropertyValue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BuyerTaxonomyPropertyValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BuyerTaxonomyPropertyValue is not found in the empty JSON string", BuyerTaxonomyPropertyValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BuyerTaxonomyPropertyValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BuyerTaxonomyPropertyValue` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BuyerTaxonomyPropertyValue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BuyerTaxonomyPropertyValue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BuyerTaxonomyPropertyValue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BuyerTaxonomyPropertyValue.class));

       return (TypeAdapter<T>) new TypeAdapter<BuyerTaxonomyPropertyValue>() {
           @Override
           public void write(JsonWriter out, BuyerTaxonomyPropertyValue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BuyerTaxonomyPropertyValue read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BuyerTaxonomyPropertyValue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BuyerTaxonomyPropertyValue
  * @throws IOException if the JSON string is invalid with respect to BuyerTaxonomyPropertyValue
  */
  public static BuyerTaxonomyPropertyValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BuyerTaxonomyPropertyValue.class);
  }

 /**
  * Convert an instance of BuyerTaxonomyPropertyValue to an JSON string
  *
  * @return JSON string
  */
