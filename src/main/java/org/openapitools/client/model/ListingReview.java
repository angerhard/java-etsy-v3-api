...
public class ListingReview {
  ...
  public ListingReview shopId(Long shopId) {
  ...
  **/
  ...
  public ListingReview listingId(Long listingId) {
  ...
  **/
  ...
  public ListingReview rating(Long rating) {
  ...
  **/
  ...
  public ListingReview review(String review) {
  ...
  **/
  ...
  public ListingReview language(String language) {
  ...
  **/
  ...
  public ListingReview imageUrlFullxfull(String imageUrlFullxfull) {
  ...
  **/
  ...
  public ListingReview createTimestamp(Long createTimestamp) {
  ...
  **/
  ...
  public ListingReview updateTimestamp(Long updateTimestamp) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListingReview listingReview = (ListingReview) o;
    return Objects.equals(this.shopId, listingReview.shopId) &&
        Objects.equals(this.listingId, listingReview.listingId) &&
        Objects.equals(this.rating, listingReview.rating) &&
        Objects.equals(this.review, listingReview.review) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListingReview
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListingReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListingReview is not found in the empty JSON string", ListingReview.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListingReview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListingReview` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListingReview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListingReview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListingReview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListingReview.class));

       return (TypeAdapter<T>) new TypeAdapter<ListingReview>() {
           @Override
           public void write(JsonWriter out, ListingReview value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListingReview read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListingReview given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListingReview
  * @throws IOException if the JSON string is invalid with respect to ListingReview
  */
  public static ListingReview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListingReview.class);
  }

 /**
  * Convert an instance of ListingReview to an JSON string
  *
  * @return JSON string
  */
