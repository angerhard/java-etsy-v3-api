...
public class ShopListingWithAssociationsImagesInner {
  ...
  public ShopListingWithAssociationsImagesInner() {
  }

  public ShopListingWithAssociationsImagesInner listingId(Long listingId) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner listingImageId(Long listingImageId) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner hexCode(String hexCode) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner red(Long red) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner green(Long green) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner blue(Long blue) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner hue(Long hue) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner saturation(Long saturation) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner brightness(Long brightness) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner isBlackAndWhite(Boolean isBlackAndWhite) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner creationTsz(Long creationTsz) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner createdTimestamp(Long createdTimestamp) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner rank(Long rank) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner url75x75(String url75x75) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner url170x135(String url170x135) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner url570xN(String url570xN) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner urlFullxfull(String urlFullxfull) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner fullHeight(Long fullHeight) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner fullWidth(Long fullWidth) {
  ...
  **/
  ...
  public ShopListingWithAssociationsImagesInner altText(String altText) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ShopListingWithAssociationsImagesInner shopListingWithAssociationsImagesInner = (ShopListingWithAssociationsImagesInner) o;
    return Objects.equals(this.listingId, shopListingWithAssociationsImagesInner.listingId) &&
        Objects.equals(this.listingImageId, shopListingWithAssociationsImagesInner.listingImageId) &&
        Objects.equals(this.hexCode, shopListingWithAssociationsImagesInner.hexCode) &&
        Objects.equals(this.red, shopListingWithAssociationsImagesInner.red) &&
        Objects.equals(this.green, shopListingWithAssociationsImagesInner.green) &&
        Objects.equals(this.blue, shopListingWithAssociationsImagesInner.blue) &&
        Objects.equals(this.hue, shopListingWithAssociationsImagesInner.hue) &&
        Objects.equals(this.saturation, shopListingWithAssociationsImagesInner.saturation) &&
        Objects.equals(this.brightness, shopListingWithAssociationsImagesInner.brightness) &&
        Objects.equals(this.isBlackAndWhite, shopListingWithAssociationsImagesInner.isBlackAndWhite) &&
        Objects.equals(this.creationTsz, shopListingWithAssociationsImagesInner.creationTsz) &&
        Objects.equals(this.createdTimestamp, shopListingWithAssociationsImagesInner.createdTimestamp) &&
        Objects.equals(this.rank, shopListingWithAssociationsImagesInner.rank) &&
        Objects.equals(this.url75x75, shopListingWithAssociationsImagesInner.url75x75) &&
        Objects.equals(this.url170x135, shopListingWithAssociationsImagesInner.url170x135) &&
        Objects.equals(this.url570xN, shopListingWithAssociationsImagesInner.url570xN) &&
        Objects.equals(this.urlFullxfull, shopListingWithAssociationsImagesInner.urlFullxfull) &&
        Objects.equals(this.fullHeight, shopListingWithAssociationsImagesInner.fullHeight) &&
        Objects.equals(this.fullWidth, shopListingWithAssociationsImagesInner.fullWidth) &&
        Objects.equals(this.altText, shopListingWithAssociationsImagesInner.altText);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopListingWithAssociationsImagesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopListingWithAssociationsImagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopListingWithAssociationsImagesInner is not found in the empty JSON string", ShopListingWithAssociationsImagesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopListingWithAssociationsImagesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopListingWithAssociationsImagesInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopListingWithAssociationsImagesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopListingWithAssociationsImagesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopListingWithAssociationsImagesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopListingWithAssociationsImagesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopListingWithAssociationsImagesInner>() {
           @Override
           public void write(JsonWriter out, ShopListingWithAssociationsImagesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopListingWithAssociationsImagesInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopListingWithAssociationsImagesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopListingWithAssociationsImagesInner
  * @throws IOException if the JSON string is invalid with respect to ShopListingWithAssociationsImagesInner
  */
  public static ShopListingWithAssociationsImagesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopListingWithAssociationsImagesInner.class);
  }

 /**
  * Convert an instance of ShopListingWithAssociationsImagesInner to an JSON string
  *
  * @return JSON string
  */
