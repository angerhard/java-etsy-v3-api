...
public class ShopListing {
  ...
  **/
  ...
  public ShopListing price(ShopListingPrice price) {
  ...
  **/
  ...
  public ShopListing readinessStateId(Long readinessStateId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.listingId, shopListing.listingId) &&
        ...
        Objects.equals(this.readinessStateId, shopListing.readinessStateId);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopListing
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopListing.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopListing is not found in the empty JSON string", ShopListing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopListing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopListing` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopListing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopListing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopListing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopListing.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopListing>() {
           @Override
           public void write(JsonWriter out, ShopListing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopListing read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopListing given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopListing
  * @throws IOException if the JSON string is invalid with respect to ShopListing
  */
  public static ShopListing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopListing.class);
  }

 /**
  * Convert an instance of ShopListing to an JSON string
  *
  * @return JSON string
  */
