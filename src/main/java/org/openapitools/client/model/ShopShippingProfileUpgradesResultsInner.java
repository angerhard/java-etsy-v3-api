...
public class ShopShippingProfileUpgradesResultsInner {
  ...
  public ShopShippingProfileUpgradesResultsInner() {
  }

  public ShopShippingProfileUpgradesResultsInner shippingProfileId(Long shippingProfileId) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner upgradeId(Long upgradeId) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner upgradeName(String upgradeName) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner type(TypeEnum type) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner rank(Long rank) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner language(String language) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner price(ShopShippingProfileUpgradePrice price) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner secondaryPrice(ShopShippingProfileUpgradeSecondaryPrice secondaryPrice) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner shippingCarrierId(Long shippingCarrierId) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner mailClass(String mailClass) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner minDeliveryDays(Long minDeliveryDays) {
  ...
  **/
  ...
  public ShopShippingProfileUpgradesResultsInner maxDeliveryDays(Long maxDeliveryDays) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ShopShippingProfileUpgradesResultsInner shopShippingProfileUpgradesResultsInner = (ShopShippingProfileUpgradesResultsInner) o;
    return Objects.equals(this.shippingProfileId, shopShippingProfileUpgradesResultsInner.shippingProfileId) &&
        Objects.equals(this.upgradeId, shopShippingProfileUpgradesResultsInner.upgradeId) &&
        Objects.equals(this.upgradeName, shopShippingProfileUpgradesResultsInner.upgradeName) &&
        Objects.equals(this.type, shopShippingProfileUpgradesResultsInner.type) &&
        Objects.equals(this.rank, shopShippingProfileUpgradesResultsInner.rank) &&
        Objects.equals(this.language, shopShippingProfileUpgradesResultsInner.language) &&
        Objects.equals(this.price, shopShippingProfileUpgradesResultsInner.price) &&
        Objects.equals(this.secondaryPrice, shopShippingProfileUpgradesResultsInner.secondaryPrice) &&
        Objects.equals(this.shippingCarrierId, shopShippingProfileUpgradesResultsInner.shippingCarrierId) &&
        Objects.equals(this.mailClass, shopShippingProfileUpgradesResultsInner.mailClass) &&
        Objects.equals(this.minDeliveryDays, shopShippingProfileUpgradesResultsInner.minDeliveryDays) &&
        Objects.equals(this.maxDeliveryDays, shopShippingProfileUpgradesResultsInner.maxDeliveryDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShopShippingProfileUpgradesResultsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopShippingProfileUpgradesResultsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopShippingProfileUpgradesResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopShippingProfileUpgradesResultsInner is not found in the empty JSON string", ShopShippingProfileUpgradesResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopShippingProfileUpgradesResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopShippingProfileUpgradesResultsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopShippingProfileUpgradesResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopShippingProfileUpgradesResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopShippingProfileUpgradesResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopShippingProfileUpgradesResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopShippingProfileUpgradesResultsInner>() {
           @Override
           public void write(JsonWriter out, ShopShippingProfileUpgradesResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopShippingProfileUpgradesResultsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopShippingProfileUpgradesResultsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopShippingProfileUpgradesResultsInner
  * @throws IOException if the JSON string is invalid with respect to ShopShippingProfileUpgradesResultsInner
  */
  public static ShopShippingProfileUpgradesResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopShippingProfileUpgradesResultsInner.class);
  }

 /**
  * Convert an instance of ShopShippingProfileUpgradesResultsInner to an JSON string
  *
  * @return JSON string
  */
