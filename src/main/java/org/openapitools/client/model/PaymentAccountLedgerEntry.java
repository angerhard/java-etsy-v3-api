...
public class PaymentAccountLedgerEntry {
  ...
  **/
  ...
  public PaymentAccountLedgerEntry paymentAdjustments(List<PaymentAccountLedgerEntryPaymentAdjustmentsInner> paymentAdjustments) {
    
    this.paymentAdjustments = paymentAdjustments;
    return this;
  }

  public PaymentAccountLedgerEntry addPaymentAdjustmentsItem(PaymentAccountLedgerEntryPaymentAdjustmentsInner paymentAdjustmentsItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentAccountLedgerEntry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentAccountLedgerEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentAccountLedgerEntry is not found in the empty JSON string", PaymentAccountLedgerEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymentAccountLedgerEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentAccountLedgerEntry` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentAccountLedgerEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentAccountLedgerEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentAccountLedgerEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentAccountLedgerEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentAccountLedgerEntry>() {
           @Override
           public void write(JsonWriter out, PaymentAccountLedgerEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentAccountLedgerEntry read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PaymentAccountLedgerEntry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PaymentAccountLedgerEntry
  * @throws IOException if the JSON string is invalid with respect to PaymentAccountLedgerEntry
  */
  public static PaymentAccountLedgerEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentAccountLedgerEntry.class);
  }

 /**
  * Convert an instance of PaymentAccountLedgerEntry to an JSON string
  *
  * @return JSON string
  */
