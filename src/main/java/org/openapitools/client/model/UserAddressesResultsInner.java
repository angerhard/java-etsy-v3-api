...
public class UserAddressesResultsInner {
  ...
  public UserAddressesResultsInner() {
  }

  public UserAddressesResultsInner userAddressId(Long userAddressId) {
  ...
  **/
  ...
  public UserAddressesResultsInner userId(Long userId) {
  ...
  **/
  ...
  public UserAddressesResultsInner name(String name) {
  ...
  **/
  ...
  public UserAddressesResultsInner firstLine(String firstLine) {
  ...
  **/
  ...
  public UserAddressesResultsInner secondLine(String secondLine) {
  ...
  **/
  ...
  public UserAddressesResultsInner city(String city) {
  ...
  **/
  ...
  public UserAddressesResultsInner state(String state) {
  ...
  **/
  ...
  public UserAddressesResultsInner zip(String zip) {
  ...
  **/
  ...
  public UserAddressesResultsInner isoCountryCode(String isoCountryCode) {
  ...
  **/
  ...
  public UserAddressesResultsInner countryName(String countryName) {
  ...
  **/
  ...
  public UserAddressesResultsInner isDefaultShippingAddress(Boolean isDefaultShippingAddress) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserAddressesResultsInner userAddressesResultsInner = (UserAddressesResultsInner) o;
    return Objects.equals(this.userAddressId, userAddressesResultsInner.userAddressId) &&
        Objects.equals(this.userId, userAddressesResultsInner.userId) &&
        Objects.equals(this.name, userAddressesResultsInner.name) &&
        Objects.equals(this.firstLine, userAddressesResultsInner.firstLine) &&
        Objects.equals(this.secondLine, userAddressesResultsInner.secondLine) &&
        Objects.equals(this.city, userAddressesResultsInner.city) &&
        Objects.equals(this.state, userAddressesResultsInner.state) &&
        Objects.equals(this.zip, userAddressesResultsInner.zip) &&
        Objects.equals(this.isoCountryCode, userAddressesResultsInner.isoCountryCode) &&
        Objects.equals(this.countryName, userAddressesResultsInner.countryName) &&
        Objects.equals(this.isDefaultShippingAddress, userAddressesResultsInner.isDefaultShippingAddress);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserAddressesResultsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserAddressesResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAddressesResultsInner is not found in the empty JSON string", UserAddressesResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UserAddressesResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAddressesResultsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAddressesResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAddressesResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAddressesResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAddressesResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAddressesResultsInner>() {
           @Override
           public void write(JsonWriter out, UserAddressesResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAddressesResultsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserAddressesResultsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserAddressesResultsInner
  * @throws IOException if the JSON string is invalid with respect to UserAddressesResultsInner
  */
  public static UserAddressesResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAddressesResultsInner.class);
  }

 /**
  * Convert an instance of UserAddressesResultsInner to an JSON string
  *
  * @return JSON string
  */
