...
public class ShopsResultsInner {
  ...
  public ShopsResultsInner() {
  }

  public ShopsResultsInner shopId(Long shopId) {
  ...
  **/
  ...
  public ShopsResultsInner userId(Long userId) {
  ...
  **/
  ...
  public ShopsResultsInner shopName(String shopName) {
  ...
  **/
  ...
  public ShopsResultsInner createDate(Long createDate) {
  ...
  **/
  ...
  public ShopsResultsInner createdTimestamp(Long createdTimestamp) {
  ...
  **/
  ...
  public ShopsResultsInner title(String title) {
  ...
  **/
  ...
  public ShopsResultsInner announcement(String announcement) {
  ...
  **/
  ...
  public ShopsResultsInner currencyCode(String currencyCode) {
  ...
  **/
  ...
  public ShopsResultsInner isVacation(Boolean isVacation) {
  ...
  **/
  ...
  public ShopsResultsInner vacationMessage(String vacationMessage) {
  ...
  **/
  ...
  public ShopsResultsInner saleMessage(String saleMessage) {
  ...
  **/
  ...
  public ShopsResultsInner digitalSaleMessage(String digitalSaleMessage) {
  ...
  **/
  ...
  public ShopsResultsInner updateDate(Long updateDate) {
  ...
  **/
  ...
  public ShopsResultsInner updatedTimestamp(Long updatedTimestamp) {
  ...
  **/
  ...
  public ShopsResultsInner listingActiveCount(Long listingActiveCount) {
  ...
  **/
  ...
  public ShopsResultsInner digitalListingCount(Long digitalListingCount) {
  ...
  **/
  ...
  public ShopsResultsInner loginName(String loginName) {
  ...
  **/
  ...
  public ShopsResultsInner acceptsCustomRequests(Boolean acceptsCustomRequests) {
  ...
  **/
  ...
  public ShopsResultsInner policyWelcome(String policyWelcome) {
  ...
  **/
  ...
  public ShopsResultsInner policyPayment(String policyPayment) {
  ...
  **/
  ...
  public ShopsResultsInner policyShipping(String policyShipping) {
  ...
  **/
  ...
  public ShopsResultsInner policyRefunds(String policyRefunds) {
  ...
  **/
  ...
  public ShopsResultsInner policyAdditional(String policyAdditional) {
  ...
  **/
  ...
  public ShopsResultsInner policySellerInfo(String policySellerInfo) {
  ...
  **/
  ...
  public ShopsResultsInner policyUpdateDate(Long policyUpdateDate) {
  ...
  **/
  ...
  public ShopsResultsInner policyHasPrivateReceiptInfo(Boolean policyHasPrivateReceiptInfo) {
  ...
  **/
  ...
  public ShopsResultsInner hasUnstructuredPolicies(Boolean hasUnstructuredPolicies) {
  ...
  **/
  ...
  public ShopsResultsInner policyPrivacy(String policyPrivacy) {
  ...
  **/
  ...
  public ShopsResultsInner vacationAutoreply(String vacationAutoreply) {
  ...
  **/
  ...
  public ShopsResultsInner url(String url) {
  ...
  **/
  ...
  public ShopsResultsInner imageUrl760x100(String imageUrl760x100) {
  ...
  **/
  ...
  public ShopsResultsInner numFavorers(Long numFavorers) {
  ...
  **/
  ...
  public ShopsResultsInner languages(List<String> languages) {
    
    this.languages = languages;
    return this;
  }

  public ShopsResultsInner addLanguagesItem(String languagesItem) {
  ...
  **/
  ...
  public ShopsResultsInner iconUrlFullxfull(String iconUrlFullxfull) {
  ...
  **/
  ...
  public ShopsResultsInner isUsingStructuredPolicies(Boolean isUsingStructuredPolicies) {
  ...
  **/
  ...
  public ShopsResultsInner hasOnboardedStructuredPolicies(Boolean hasOnboardedStructuredPolicies) {
  ...
  **/
  ...
  public ShopsResultsInner includeDisputeFormLink(Boolean includeDisputeFormLink) {
  ...
  **/
  ...
  public ShopsResultsInner isDirectCheckoutOnboarded(Boolean isDirectCheckoutOnboarded) {
  ...
  **/
  ...
  public ShopsResultsInner isEtsyPaymentsOnboarded(Boolean isEtsyPaymentsOnboarded) {
  ...
  **/
  ...
  public ShopsResultsInner isCalculatedEligible(Boolean isCalculatedEligible) {
  ...
  **/
  ...
  public ShopsResultsInner isOptedInToBuyerPromise(Boolean isOptedInToBuyerPromise) {
  ...
  **/
  ...
  public ShopsResultsInner isShopUsBased(Boolean isShopUsBased) {
  ...
  **/
  ...
  public ShopsResultsInner transactionSoldCount(Long transactionSoldCount) {
  ...
  **/
  ...
  public ShopsResultsInner shippingFromCountryIso(String shippingFromCountryIso) {
  ...
  **/
  ...
  public ShopsResultsInner shopLocationCountryIso(String shopLocationCountryIso) {
  ...
  **/
  ...
  public ShopsResultsInner reviewCount(Long reviewCount) {
  ...
  **/
  ...
  public ShopsResultsInner reviewAverage(Float reviewAverage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ShopsResultsInner shopsResultsInner = (ShopsResultsInner) o;
    return Objects.equals(this.shopId, shopsResultsInner.shopId) &&
        Objects.equals(this.userId, shopsResultsInner.userId) &&
        Objects.equals(this.shopName, shopsResultsInner.shopName) &&
        Objects.equals(this.createDate, shopsResultsInner.createDate) &&
        Objects.equals(this.createdTimestamp, shopsResultsInner.createdTimestamp) &&
        Objects.equals(this.title, shopsResultsInner.title) &&
        Objects.equals(this.announcement, shopsResultsInner.announcement) &&
        Objects.equals(this.currencyCode, shopsResultsInner.currencyCode) &&
        Objects.equals(this.isVacation, shopsResultsInner.isVacation) &&
        Objects.equals(this.vacationMessage, shopsResultsInner.vacationMessage) &&
        Objects.equals(this.saleMessage, shopsResultsInner.saleMessage) &&
        Objects.equals(this.digitalSaleMessage, shopsResultsInner.digitalSaleMessage) &&
        Objects.equals(this.updateDate, shopsResultsInner.updateDate) &&
        Objects.equals(this.updatedTimestamp, shopsResultsInner.updatedTimestamp) &&
        Objects.equals(this.listingActiveCount, shopsResultsInner.listingActiveCount) &&
        Objects.equals(this.digitalListingCount, shopsResultsInner.digitalListingCount) &&
        Objects.equals(this.loginName, shopsResultsInner.loginName) &&
        Objects.equals(this.acceptsCustomRequests, shopsResultsInner.acceptsCustomRequests) &&
        Objects.equals(this.policyWelcome, shopsResultsInner.policyWelcome) &&
        Objects.equals(this.policyPayment, shopsResultsInner.policyPayment) &&
        Objects.equals(this.policyShipping, shopsResultsInner.policyShipping) &&
        Objects.equals(this.policyRefunds, shopsResultsInner.policyRefunds) &&
        Objects.equals(this.policyAdditional, shopsResultsInner.policyAdditional) &&
        Objects.equals(this.policySellerInfo, shopsResultsInner.policySellerInfo) &&
        Objects.equals(this.policyUpdateDate, shopsResultsInner.policyUpdateDate) &&
        Objects.equals(this.policyHasPrivateReceiptInfo, shopsResultsInner.policyHasPrivateReceiptInfo) &&
        Objects.equals(this.hasUnstructuredPolicies, shopsResultsInner.hasUnstructuredPolicies) &&
        Objects.equals(this.policyPrivacy, shopsResultsInner.policyPrivacy) &&
        Objects.equals(this.vacationAutoreply, shopsResultsInner.vacationAutoreply) &&
        Objects.equals(this.url, shopsResultsInner.url) &&
        Objects.equals(this.imageUrl760x100, shopsResultsInner.imageUrl760x100) &&
        Objects.equals(this.numFavorers, shopsResultsInner.numFavorers) &&
        Objects.equals(this.languages, shopsResultsInner.languages) &&
        Objects.equals(this.iconUrlFullxfull, shopsResultsInner.iconUrlFullxfull) &&
        Objects.equals(this.isUsingStructuredPolicies, shopsResultsInner.isUsingStructuredPolicies) &&
        Objects.equals(this.hasOnboardedStructuredPolicies, shopsResultsInner.hasOnboardedStructuredPolicies) &&
        Objects.equals(this.includeDisputeFormLink, shopsResultsInner.includeDisputeFormLink) &&
        Objects.equals(this.isDirectCheckoutOnboarded, shopsResultsInner.isDirectCheckoutOnboarded) &&
        Objects.equals(this.isEtsyPaymentsOnboarded, shopsResultsInner.isEtsyPaymentsOnboarded) &&
        Objects.equals(this.isCalculatedEligible, shopsResultsInner.isCalculatedEligible) &&
        Objects.equals(this.isOptedInToBuyerPromise, shopsResultsInner.isOptedInToBuyerPromise) &&
        Objects.equals(this.isShopUsBased, shopsResultsInner.isShopUsBased) &&
        Objects.equals(this.transactionSoldCount, shopsResultsInner.transactionSoldCount) &&
        Objects.equals(this.shippingFromCountryIso, shopsResultsInner.shippingFromCountryIso) &&
        Objects.equals(this.shopLocationCountryIso, shopsResultsInner.shopLocationCountryIso) &&
        Objects.equals(this.reviewCount, shopsResultsInner.reviewCount) &&
        Objects.equals(this.reviewAverage, shopsResultsInner.reviewAverage);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopsResultsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopsResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopsResultsInner is not found in the empty JSON string", ShopsResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopsResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopsResultsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopsResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopsResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopsResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopsResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopsResultsInner>() {
           @Override
           public void write(JsonWriter out, ShopsResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopsResultsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopsResultsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopsResultsInner
  * @throws IOException if the JSON string is invalid with respect to ShopsResultsInner
  */
  public static ShopsResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopsResultsInner.class);
  }

 /**
  * Convert an instance of ShopsResultsInner to an JSON string
  *
  * @return JSON string
  */
