...
public class TransactionReview {
  ...
  **/
  ...
  public TransactionReview createdTimestamp(Long createdTimestamp) {
  ...
  **/
  ...
  public TransactionReview updatedTimestamp(Long updatedTimestamp) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.shopId, transactionReview.shopId) &&
        ...
        Objects.equals(this.createdTimestamp, transactionReview.createdTimestamp) &&
        Objects.equals(this.updateTimestamp, transactionReview.updateTimestamp) &&
        Objects.equals(this.updatedTimestamp, transactionReview.updatedTimestamp);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransactionReview
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransactionReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionReview is not found in the empty JSON string", TransactionReview.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TransactionReview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionReview` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionReview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionReview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionReview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionReview.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionReview>() {
           @Override
           public void write(JsonWriter out, TransactionReview value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactionReview read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TransactionReview given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransactionReview
  * @throws IOException if the JSON string is invalid with respect to TransactionReview
  */
  public static TransactionReview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionReview.class);
  }

 /**
  * Convert an instance of TransactionReview to an JSON string
  *
  * @return JSON string
  */
