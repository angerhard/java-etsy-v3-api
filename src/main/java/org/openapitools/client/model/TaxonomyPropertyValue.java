...
public class TaxonomyPropertyValue {
  ...
  **/
  ...
  public TaxonomyPropertyValue name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TaxonomyPropertyValue taxonomyPropertyValue = (TaxonomyPropertyValue) o;
    return Objects.equals(this.valueId, taxonomyPropertyValue.valueId) &&
        Objects.equals(this.name, taxonomyPropertyValue.name) &&
        Objects.equals(this.scaleId, taxonomyPropertyValue.scaleId) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxonomyPropertyValue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxonomyPropertyValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxonomyPropertyValue is not found in the empty JSON string", TaxonomyPropertyValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TaxonomyPropertyValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaxonomyPropertyValue` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxonomyPropertyValue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxonomyPropertyValue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxonomyPropertyValue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxonomyPropertyValue.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxonomyPropertyValue>() {
           @Override
           public void write(JsonWriter out, TaxonomyPropertyValue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaxonomyPropertyValue read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TaxonomyPropertyValue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxonomyPropertyValue
  * @throws IOException if the JSON string is invalid with respect to TaxonomyPropertyValue
  */
  public static TaxonomyPropertyValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxonomyPropertyValue.class);
  }

 /**
  * Convert an instance of TaxonomyPropertyValue to an JSON string
  *
  * @return JSON string
  */
