...
public class ShopReceiptTransaction {
  ...
  **/
  ...
  public ShopReceiptTransaction price(ShopReceiptTransactionPrice price) {
  ...
  **/
  ...
  public ShopReceiptTransaction shippingCost(ShopReceiptTransactionShippingCost shippingCost) {
  ...
  **/
  ...
  public ShopReceiptTransaction variations(List<ShopReceiptTransactionVariationsInner> variations) {
    
    this.variations = variations;
    return this;
  }

  public ShopReceiptTransaction addVariationsItem(ShopReceiptTransactionVariationsInner variationsItem) {
  ...
  **/
  ...
  public ShopReceiptTransaction productData(List<ListingInventoryProductPropertyValuesInner> productData) {
    
    this.productData = productData;
    return this;
  }

  public ShopReceiptTransaction addProductDataItem(ListingInventoryProductPropertyValuesInner productDataItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopReceiptTransaction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopReceiptTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopReceiptTransaction is not found in the empty JSON string", ShopReceiptTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopReceiptTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopReceiptTransaction` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopReceiptTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopReceiptTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopReceiptTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopReceiptTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopReceiptTransaction>() {
           @Override
           public void write(JsonWriter out, ShopReceiptTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopReceiptTransaction read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopReceiptTransaction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopReceiptTransaction
  * @throws IOException if the JSON string is invalid with respect to ShopReceiptTransaction
  */
  public static ShopReceiptTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopReceiptTransaction.class);
  }

 /**
  * Convert an instance of ShopReceiptTransaction to an JSON string
  *
  * @return JSON string
  */
