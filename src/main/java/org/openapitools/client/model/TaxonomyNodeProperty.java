...
public class TaxonomyNodeProperty {
  ...
  **/
  ...
  public TaxonomyNodeProperty scales(List<TaxonomyNodePropertyScalesInner> scales) {
    
    this.scales = scales;
    return this;
  }

  public TaxonomyNodeProperty addScalesItem(TaxonomyNodePropertyScalesInner scalesItem) {
    if (this.scales == null) {
  ...
  **/
  ...
  public TaxonomyNodeProperty maxValuesAllowed(Long maxValuesAllowed) {
  ...
  **/
  ...
  public TaxonomyNodeProperty possibleValues(List<TaxonomyNodePropertyPossibleValuesInner> possibleValues) {
    
    this.possibleValues = possibleValues;
    return this;
  }

  public TaxonomyNodeProperty addPossibleValuesItem(TaxonomyNodePropertyPossibleValuesInner possibleValuesItem) {
  ...
  **/
  ...
  public TaxonomyNodeProperty selectedValues(List<TaxonomyNodePropertySelectedValuesInner> selectedValues) {
    
    this.selectedValues = selectedValues;
    return this;
  }

  public TaxonomyNodeProperty addSelectedValuesItem(TaxonomyNodePropertySelectedValuesInner selectedValuesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.propertyId, taxonomyNodeProperty.propertyId) &&
        ...
        Objects.equals(this.maxValuesAllowed, taxonomyNodeProperty.maxValuesAllowed) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to TaxonomyNodeProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TaxonomyNodeProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxonomyNodeProperty is not found in the empty JSON string", TaxonomyNodeProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TaxonomyNodeProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaxonomyNodeProperty` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxonomyNodeProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxonomyNodeProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxonomyNodeProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxonomyNodeProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxonomyNodeProperty>() {
           @Override
           public void write(JsonWriter out, TaxonomyNodeProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaxonomyNodeProperty read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TaxonomyNodeProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TaxonomyNodeProperty
  * @throws IOException if the JSON string is invalid with respect to TaxonomyNodeProperty
  */
  public static TaxonomyNodeProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxonomyNodeProperty.class);
  }

 /**
  * Convert an instance of TaxonomyNodeProperty to an JSON string
  *
  * @return JSON string
  */
