...
public class ShopReceiptTransactionsResultsInner {
  ...
  public ShopReceiptTransactionsResultsInner() {
  }

  public ShopReceiptTransactionsResultsInner transactionId(Long transactionId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner title(String title) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner description(String description) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner sellerUserId(Long sellerUserId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner buyerUserId(Long buyerUserId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner createTimestamp(Long createTimestamp) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner createdTimestamp(Long createdTimestamp) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner paidTimestamp(Long paidTimestamp) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner shippedTimestamp(Long shippedTimestamp) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner quantity(Long quantity) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner listingImageId(Long listingImageId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner receiptId(Long receiptId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner isDigital(Boolean isDigital) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner fileData(String fileData) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner listingId(Long listingId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner transactionType(String transactionType) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner productId(Long productId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner sku(String sku) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner price(ShopReceiptTransactionPrice price) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner shippingCost(ShopReceiptTransactionShippingCost shippingCost) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner variations(List<ShopReceiptTransactionVariationsInner> variations) {
    
    this.variations = variations;
    return this;
  }

  public ShopReceiptTransactionsResultsInner addVariationsItem(ShopReceiptTransactionVariationsInner variationsItem) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner productData(List<ListingInventoryProductPropertyValuesInner> productData) {
    
    this.productData = productData;
    return this;
  }

  public ShopReceiptTransactionsResultsInner addProductDataItem(ListingInventoryProductPropertyValuesInner productDataItem) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner shippingProfileId(Long shippingProfileId) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner minProcessingDays(Long minProcessingDays) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner maxProcessingDays(Long maxProcessingDays) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner shippingMethod(String shippingMethod) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner shippingUpgrade(String shippingUpgrade) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner expectedShipDate(Long expectedShipDate) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner buyerCoupon(Float buyerCoupon) {
  ...
  **/
  ...
  public ShopReceiptTransactionsResultsInner shopCoupon(Float shopCoupon) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ShopReceiptTransactionsResultsInner shopReceiptTransactionsResultsInner = (ShopReceiptTransactionsResultsInner) o;
    return Objects.equals(this.transactionId, shopReceiptTransactionsResultsInner.transactionId) &&
        Objects.equals(this.title, shopReceiptTransactionsResultsInner.title) &&
        Objects.equals(this.description, shopReceiptTransactionsResultsInner.description) &&
        Objects.equals(this.sellerUserId, shopReceiptTransactionsResultsInner.sellerUserId) &&
        Objects.equals(this.buyerUserId, shopReceiptTransactionsResultsInner.buyerUserId) &&
        Objects.equals(this.createTimestamp, shopReceiptTransactionsResultsInner.createTimestamp) &&
        Objects.equals(this.createdTimestamp, shopReceiptTransactionsResultsInner.createdTimestamp) &&
        Objects.equals(this.paidTimestamp, shopReceiptTransactionsResultsInner.paidTimestamp) &&
        Objects.equals(this.shippedTimestamp, shopReceiptTransactionsResultsInner.shippedTimestamp) &&
        Objects.equals(this.quantity, shopReceiptTransactionsResultsInner.quantity) &&
        Objects.equals(this.listingImageId, shopReceiptTransactionsResultsInner.listingImageId) &&
        Objects.equals(this.receiptId, shopReceiptTransactionsResultsInner.receiptId) &&
        Objects.equals(this.isDigital, shopReceiptTransactionsResultsInner.isDigital) &&
        Objects.equals(this.fileData, shopReceiptTransactionsResultsInner.fileData) &&
        Objects.equals(this.listingId, shopReceiptTransactionsResultsInner.listingId) &&
        Objects.equals(this.transactionType, shopReceiptTransactionsResultsInner.transactionType) &&
        Objects.equals(this.productId, shopReceiptTransactionsResultsInner.productId) &&
        Objects.equals(this.sku, shopReceiptTransactionsResultsInner.sku) &&
        Objects.equals(this.price, shopReceiptTransactionsResultsInner.price) &&
        Objects.equals(this.shippingCost, shopReceiptTransactionsResultsInner.shippingCost) &&
        Objects.equals(this.variations, shopReceiptTransactionsResultsInner.variations) &&
        Objects.equals(this.productData, shopReceiptTransactionsResultsInner.productData) &&
        Objects.equals(this.shippingProfileId, shopReceiptTransactionsResultsInner.shippingProfileId) &&
        Objects.equals(this.minProcessingDays, shopReceiptTransactionsResultsInner.minProcessingDays) &&
        Objects.equals(this.maxProcessingDays, shopReceiptTransactionsResultsInner.maxProcessingDays) &&
        Objects.equals(this.shippingMethod, shopReceiptTransactionsResultsInner.shippingMethod) &&
        Objects.equals(this.shippingUpgrade, shopReceiptTransactionsResultsInner.shippingUpgrade) &&
        Objects.equals(this.expectedShipDate, shopReceiptTransactionsResultsInner.expectedShipDate) &&
        Objects.equals(this.buyerCoupon, shopReceiptTransactionsResultsInner.buyerCoupon) &&
        Objects.equals(this.shopCoupon, shopReceiptTransactionsResultsInner.shopCoupon);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShopReceiptTransactionsResultsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShopReceiptTransactionsResultsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShopReceiptTransactionsResultsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopReceiptTransactionsResultsInner is not found in the empty JSON string", ShopReceiptTransactionsResultsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ShopReceiptTransactionsResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopReceiptTransactionsResultsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopReceiptTransactionsResultsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopReceiptTransactionsResultsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopReceiptTransactionsResultsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopReceiptTransactionsResultsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopReceiptTransactionsResultsInner>() {
           @Override
           public void write(JsonWriter out, ShopReceiptTransactionsResultsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopReceiptTransactionsResultsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ShopReceiptTransactionsResultsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShopReceiptTransactionsResultsInner
  * @throws IOException if the JSON string is invalid with respect to ShopReceiptTransactionsResultsInner
  */
  public static ShopReceiptTransactionsResultsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopReceiptTransactionsResultsInner.class);
  }

 /**
  * Convert an instance of ShopReceiptTransactionsResultsInner to an JSON string
  *
  * @return JSON string
  */
