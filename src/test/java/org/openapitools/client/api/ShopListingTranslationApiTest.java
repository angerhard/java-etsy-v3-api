...
/**
 * API tests for ShopListingTranslationApi
 */
@Disabled
public class ShopListingTranslationApiTest {

    private final ShopListingTranslationApi api = new ShopListingTranslationApi();
     ...
     */
    @Test
    public void createListingTranslationTest() throws ApiException {
        Long shopId = null;
        Long listingId = null;
        ...
        ListingTranslation response = api.createListingTranslation(shopId, listingId, language, title, description, tags);
     ...
     */
    @Test
    public void getListingTranslationTest() throws ApiException {
        Long shopId = null;
        Long listingId = null;
        String language = null;
        ListingTranslation response = api.getListingTranslation(shopId, listingId, language);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateListingTranslationTest() throws ApiException {
        Long shopId = null;
        Long listingId = null;
        String language = null;
        String title = null;
        String description = null;
        List<String> tags = null;
        ListingTranslation response = api.updateListingTranslation(shopId, listingId, language, title, description, tags);
        // TODO: test validations
    }
