...
/**
 * API tests for ShopListingProductApi
 */
@Disabled
public class ShopListingProductApiTest {

    private final ShopListingProductApi api = new ShopListingProductApi();
     ...
     */
    @Test
    public void getListingProductTest() throws ApiException {
        Long listingId = null;
        Long productId = null;
        Boolean legacy = null;
        ListingInventoryProduct response = api.getListingProduct(listingId, productId, legacy);
