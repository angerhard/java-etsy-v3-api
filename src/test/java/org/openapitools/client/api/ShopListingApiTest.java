...
public class ShopListingApiTest {
    ...
    public void getListingTest() throws ApiException {
        ...
        ShopListingWithAssociations response = api.getListing(listingId, includes, language);
        // TODO: test validations
    }
    ...
    public void getListingsByShopTest() throws ApiException {
        ...
        String sortOrder = null;
        List<String> includes = null;
        ShopListingsWithAssociations response = api.getListingsByShop(shopId, state, limit, offset, sortOn, sortOrder, includes);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateListingDeprecatedTest() throws ApiException {
        Long shopId = null;
        Long listingId = null;
        List<Long> imageIds = null;
        String title = null;
        ...
        List<Long> productionPartnerIds = null;
        String type = null;
        ShopListing response = api.updateListingDeprecated(shopId, listingId, imageIds, title, description, materials, shouldAutoRenew, shippingProfileId, shopSectionId, itemWeight, itemLength, itemWidth, itemHeight, itemWeightUnit, itemDimensionsUnit, isTaxable, taxonomyId, tags, whoMade, whenMade, featuredRank, isPersonalizable, personalizationIsRequired, personalizationCharCountMax, personalizationInstructions, state, isSupply, productionPartnerIds, type);
        // TODO: test validations
    }
