...
/**
 * API tests for ShopProductionPartnerApi
 */
@Disabled
public class ShopProductionPartnerApiTest {

    private final ShopProductionPartnerApi api = new ShopProductionPartnerApi();
     ...
     */
    @Test
    public void getShopProductionPartnersTest() throws ApiException {
        Long shopId = null;
        ShopProductionPartners response = api.getShopProductionPartners(shopId);
